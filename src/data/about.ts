...
export const ABOUT = {
	...
	ko: {
		...
		bio: [
			...
			'이 관심은 오랜 기술 경력에서 출발했습니다. C/C++와 Java로 11년 넘게 개발을 하다가 코드를 작성하는 일에서 제품을 만드는 일로 옮겨 갔습니다. 미디어·엔터테인먼트 기술 분야에서 프로덕트 매니지먼트와 개발자 관계 업무를 맡았고, OTT·스트리밍과 DRM·콘텐츠 보안을 주로 다루었으며 최근에는 DoveRunner와 PallyCon에서 일하고 있습니다.',
