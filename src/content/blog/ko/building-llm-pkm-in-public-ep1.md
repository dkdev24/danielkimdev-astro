...
저는 이 과정을 공개적으로 기록하면서 두 가지를 얻으려 합니다. 첫째는 **저 자신에 대한 책임**입니다. 글로 쓰면 더 정밀하게 생각하게 됩니다. 둘째는 **비슷한 길을 찾는 사람에게 참고가 되는 것**입니다. 제가 겪은 시행착오가 누군가의 시간을 아껴줄 수 있습니다.
