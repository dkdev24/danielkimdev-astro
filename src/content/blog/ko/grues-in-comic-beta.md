...
**첫 번째는 임포터입니다.** ZIL로 작성된 Zork I의 소스를 파싱해서 [추상 구문 트리(Abstract Syntax Tree, AST)](https://en.wikipedia.org/wiki/Abstract_syntax_tree)로 만드는 단계입니다. 이 과정을 거쳐 원작이 가진 방(room), 오브젝트, 파서 규칙, 루틴을 모두 프로그램이 읽을 수 있는 형태로 뽑아냅니다.
