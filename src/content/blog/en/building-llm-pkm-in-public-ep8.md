---
title: "The Registry Meant to Stop Guessing Was Full of Guesses: Auditing My Source Trust Data"
...
Two of the twelve had real evidence behind them. The other ten were the agent's best guesses about what those outlets were probably worth, stored in a file that looked, for all practical purposes, like confirmed facts.
...
The registry now marks confirmed and unconfirmed entries explicitly, so trust doesn't quietly average down to the weakest one in the file. It keeps improving with use: each new ingest either reinforces an existing entry or adds evidence to an unconfirmed one. What's confirmed stays confirmed; what's uncertain stays marked as uncertain until it isn't.

## Next episode

Sources started piling up in the inbox faster than I could review them one at a time, and the shortcut I started reaching for is exactly what you'd expect. Next episode covers what that looked like and how I designed around it.
