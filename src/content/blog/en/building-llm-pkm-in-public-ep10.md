...
The argument: when you let AI handle the summarizing and linking in a PKM system, you lose the "germane load," the productive cognitive effort that actually builds your mental schema. Note-linking is the moment you retrieve something from long-term memory and re-encode it in relation to something new, not just administrative overhead. Hand that process to an AI and the knowledge graph looks well-connected, but nothing lands in your head.
...
So I shifted the question, from "how do I reduce AI involvement" to "where should I actually spend my limited time?"
