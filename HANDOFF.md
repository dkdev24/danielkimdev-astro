...
**Status:** **LIVE** at https://danielkimdev.pages.dev. All of P0 (Stages 01–21) is shipped. Remaining = custom domain (deferred), post-deploy Lighthouse, content `TODO(daniel)` items, and the P1 backlog — none block launch.
...
3. **Content `TODO(daniel)`** (non-blocking, fallbacks in place): headshot `/public/images/daniel.jpg`; KO native copy; portfolio metrics; timeline dates/orgs; real post seeds.
